...
public:
  CodaTableCatalogEntry(Catalog &catalog, SchemaCatalogEntry &schema,
                        CreateTableInfo &info, CodaTableInfo table);
  ...
  const CodaTableInfo &TableInfo() const { return table; }
