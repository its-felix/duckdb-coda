...
CodaTransaction::CodaTransaction(TransactionManager &manager, ClientContext &context) : Transaction(manager, context) {
}
...
CodaTransactionManager::CodaTransactionManager(AttachedDatabase &db) : TransactionManager(db) {
}
...
ErrorData CodaTransactionManager::CommitTransaction(ClientContext &, Transaction &transaction) {
